...
6. [**ai-boost/awesome-harness-engineering**](https://github.com/ai-boost/awesome-harness-engineering) (★ 4.2k+) — A collection of tools / patterns / eval / memory / MCP / observability for agent harnesses
